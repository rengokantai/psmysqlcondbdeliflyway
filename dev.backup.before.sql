...
INSERT INTO `employees` VALUES (1,1,NULL,'k y');
...
/*!50001 VIEW `employee_positions` AS select `employees`.`id` AS `employee_id`,`employees`.`name` AS `name`,`titles`.`title` AS `title` from (`employees` left join `titles` on((`employees`.`title_id` = `titles`.`id`))) */;
...
-- Dump completed on 2016-04-18 12:26:33
